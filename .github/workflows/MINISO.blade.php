...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 35 828 5947</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> trangvu@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>MINISO</span>-Store</h1>
                                    <h2>Free E-Commerce Template</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="pulic/frontend/images/home/girl1.jpg" class="girl img-responsive" alt="" />
                                    <img src="pulic/frontend/images/home/pricing.png"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="pulic/frontend/images/home/girl2.jpg" class="girl img-responsive" alt="" />
                                    <img src="pulic/frontend/images/home/pricing.png"  class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>MINISO</span>-Stores</h1>
                                    <h2>Free Ecommerce Template</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="pulic/frontend/images/home/girl3.jpg" class="girl img-responsive" alt="" />
                                    <img src="pulic/frontend/images/home/pricing.png" class="pricing" alt="" />
                                </div>
                            </div>
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2013 MINISO-storeInc. All rights reserved.</p>
